...
func (bc *BookingCreate) SetBookingDate(s string) *BookingCreate {
	bc.mutation.SetBookingDate(s)
	return bc
}

// SetCancelDate sets the "cancel_date" field.
func (bc *BookingCreate) SetCancelDate(s string) *BookingCreate {
	bc.mutation.SetCancelDate(s)
	return bc
}
...
func (bc *BookingCreate) createSpec() (*Booking, *sqlgraph.CreateSpec) {
	...
	if value, ok := bc.mutation.BookingDate(); ok {
		_spec.SetField(booking.FieldBookingDate, field.TypeString, value)
		_node.BookingDate = value
	}
	if value, ok := bc.mutation.CancelDate(); ok {
		_spec.SetField(booking.FieldCancelDate, field.TypeString, value)
