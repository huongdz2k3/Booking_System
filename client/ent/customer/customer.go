...
// RoleSUBSCRIBER is the default value of the Role enum.
const DefaultRole = RoleSUBSCRIBER
...
func RoleValidator(r Role) error {
	switch r {
	case RoleSUBSCRIBER, RoleADMIN:
		return nil
	default:
		return fmt.Errorf("customer: invalid enum value for role field: %q", r)
	}
}
