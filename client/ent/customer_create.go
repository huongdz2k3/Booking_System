...
func (cc *CustomerCreate) SetMembershipNumber(i int) *CustomerCreate {
	cc.mutation.SetMembershipNumber(i)
	return cc
}
...
func (cc *CustomerCreate) SetCreateAt(t time.Time) *CustomerCreate {
	cc.mutation.SetCreateAt(t)
	return cc
}

// SetNillableCreateAt sets the "create_at" field if the given value is not nil.
func (cc *CustomerCreate) SetNillableCreateAt(t *time.Time) *CustomerCreate {
	if t != nil {
		cc.SetCreateAt(*t)
	}
	return cc
...
func (cc *CustomerCreate) SetUpdateAt(t time.Time) *CustomerCreate {
	cc.mutation.SetUpdateAt(t)
	return cc
}

// SetNillableUpdateAt sets the "update_at" field if the given value is not nil.
func (cc *CustomerCreate) SetNillableUpdateAt(t *time.Time) *CustomerCreate {
	if t != nil {
		cc.SetUpdateAt(*t)
	}
	return cc
...
func (cc *CustomerCreate) SetRole(c customer.Role) *CustomerCreate {
	cc.mutation.SetRole(c)
	return cc
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (cc *CustomerCreate) SetNillableRole(c *customer.Role) *CustomerCreate {
	if c != nil {
		cc.SetRole(*c)
	}
	return cc
...
func (cc *CustomerCreate) check() error {
	...
	if _, ok := cc.mutation.CreateAt(); !ok {
		return &ValidationError{Name: "create_at", err: errors.New(`ent: missing required field "Customer.create_at"`)}
	}
	if _, ok := cc.mutation.UpdateAt(); !ok {
		return &ValidationError{Name: "update_at", err: errors.New(`ent: missing required field "Customer.update_at"`)}
	}
	if _, ok := cc.mutation.Role(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`ent: missing required field "Customer.role"`)}
	}
