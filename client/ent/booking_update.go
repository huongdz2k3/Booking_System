...
func (bu *BookingUpdate) SetBookingDate(s string) *BookingUpdate {
	bu.mutation.SetBookingDate(s)
	return bu
}

// SetCancelDate sets the "cancel_date" field.
func (bu *BookingUpdate) SetCancelDate(s string) *BookingUpdate {
	bu.mutation.SetCancelDate(s)
	return bu
}
...
// SetBookingDate sets the "booking_date" field.
func (buo *BookingUpdateOne) SetBookingDate(s string) *BookingUpdateOne {
	buo.mutation.SetBookingDate(s)
	return buo
}

// SetCancelDate sets the "cancel_date" field.
func (buo *BookingUpdateOne) SetCancelDate(s string) *BookingUpdateOne {
	buo.mutation.SetCancelDate(s)
	return buo
}
