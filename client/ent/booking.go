...
func (*Booking) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case booking.FieldBookingCode, booking.FieldBookingDate, booking.FieldCancelDate, booking.FieldStatus, booking.FieldCustomerName, booking.FieldPhoneNumber, booking.FieldDob, booking.FieldEmail, booking.FieldLicenseID, booking.FieldAddress:
...
func (b *Booking) String() string {
	...
	builder.WriteString(b.BookingDate)
	builder.WriteString(", ")
